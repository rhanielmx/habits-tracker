...
export function HabitDay({ defaultCompleted = 0, amount = 0, date }: HabitDayProps) {
    ...
    return (
        <Popover.Root>
            ...
            />
            <Popover.Portal>
                <Popover.Content className='min-w-[320px] p-6 rounded-2xl bg-zinc-900 flex flex-col focus:outline-none focus:ring-2 focus:ring-violet-600'>
                    ...
                    <Popover.Arrow height={8} width={16} className='fill-zinc-900 border-t-2 border-t-violet-600' />
                </Popover.Content>
            </Popover.Portal>
        </Popover.Root>
    )
